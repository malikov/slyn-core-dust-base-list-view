...
module.exports = Backbone.View.extend({
    ...
    initialize: function(options) {
        ...
        this.loadCached = (options.loadCached)? options.loadCached : false;
        this.cachedData = (options.cachedData)? options.cachedData : null;
    ...
    appendItem: function(itemDom){
        if(this.listWrapper !== null){
            ...
            if(this.loadCached){
                item = itemDom.attr('data-bind','click:clickItem');
            }
            
            Backbone.$(this.listWrapper).append(item);
        }else{
    ...
    render: function(options) {
        ...
        this.renderedItems.concat(opt.data.items);
        ...
        if(this.rendered){
            ...
            setTimeout(function() {
                ...
                if(this.loadCached && this.cachedData){
                    this.renderItems(this.cachedData.items);
                }else{
                    this.renderItems(opt.data.items);
                }
